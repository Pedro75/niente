...
<meta property="og:url" content="http://www.ildolcefarniente.it" />
<meta property="og:image" content="http://www.ildolcefarniente.it/images/nientelogo.png" />
<meta property="og:site_name" content="Il dolce far niente" />
<meta property="fb:admins" content="617109795" /><!-- cascading style sheets -->
...
Nifty("div.entryred","tl bottom big fixed-height");
}
</script>
...
<?php include("script.php");
 ?>
<!-- Start adds Google Analytics for www.ildolcefarniente.it -->
 <script type="text/javascript">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-27210451-1']);
...
ul#about li{float:left;width: 210px; height:150px;
    padding: 30px 10px 20px 20px;margin:8px 8px 0 0}
	
li#ab1{background: red}
li#ab2{background: #00CC33}
li#ab3{background: #9933CC}
li#ab4{background: #FFCC00}
li#ab5{background: #0033FF}
li#ab6{background: #FF9900;color: #000}
</style>
<script type="text/javascript" src="niftycube.js"></script>
<script type="text/javascript">
window.onload=function(){
