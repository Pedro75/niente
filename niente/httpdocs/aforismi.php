			...
			<div id="right720">
				...
				<br />
	  			...
	  			<div class="dotted720"></div>
									...
									echo   "<div class=\"letterag\"><a href=\"aforismi.php?id=$alfabeto[$i]\">  $alfabeto[$i]<a></div>";
									$i=$i+1;
									}
									echo "</div>";
									?>
...
<br />	  			
				...
				$letter = $_GET['id'];
				if (isset($letter)){
				$query = "select * from item where categoria = \"Aforismi\" and (autore like '$letter%' or autore like '<p>$letter%') order by \"autore\"";}
				else {
				$query = "select * from item where categoria = \"Aforismi\" order by \"autore\"";
				}
