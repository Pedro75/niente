...
<?php <script type="text/javascript" src="tinymce/jscripts/tiny_mce/tiny_mce.js" ></script >
...
*/
  ...
  $sql = "insert into item (aid,categoria,data,contenuto,spiegazione,foto,autore,pub) values ('$aid', '$categoria','$data','$contenuto','$spiegazione','$foto', '$autore', '$pub')";
...
<form action="<? echo $_SERVER['PHP_SELF']; ?>" method="post">
 ...
 /*<fieldset>
  ...
  <select name="categoria" value="<?php echo $c1; ?>">
   ...
   <option value="Aforismi">Poesie</option>
...
--> 
 ...
 <br /><br />
 Data:  <input name="data" type="text" size="10" maxlength="10" value="<?php echo date("d-m-Y"); ?>" />
...
<label>Il file deve essre jpeg,gif,png minore di 4Mb:</label><br /><br />
