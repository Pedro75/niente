		...
		<div id="white-wrap-inside">
			...
			<div id="right720">
				...
				<div>
									...
									echo   "<div class=\"letterao\"><a href=\"film.php?id=$alfabeto[$i]\">  $alfabeto[$i]<a></div>";
									$i=$i+1;
									}
									echo "</div>";
									?>
...
<br />	  			
				...
				$letter = $_GET['id'];
				if (isset($letter)){
				$query = "select * from item where categoria = \"da Film\" and (contenuto like '$letter%' or contenuto like '<p>$letter%') order by \"contenuto\"";}
				else {
				$query = "select * from item where categoria = \"da Film\" order by \"contenuto\"";
				}
