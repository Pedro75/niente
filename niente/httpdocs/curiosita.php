				...
				<br />
	  			...
	  			<div class="dotted720"></div>
								...
								<div>	
									...
									echo   "<div class=\"letteray\"><a href=\"curiosita.php?id=$alfabeto[$i]\">  $alfabeto[$i]<a></div>";
									$i=$i+1;
									}
									echo "</div>";
									?>
...
<br />	  			
				...
				if (isset($letter)){
				$query = "select * from item where categoria = \"curiosita\" and (contenuto like '$letter%' or contenuto like '<p>$letter%') order by \"contenuto\"";}
				else {
				$query = "select * from item where categoria = \"curiosita\" order by \"contenuto\"";
				}
