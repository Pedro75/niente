			...
			<div id="right720">
				...
				<br />
	  			...
	  			<div class="dotted720"></div>
									...
									echo   "<div class=\"letterav\"><a href=\"poesie.php?id=$alfabeto[$i]\">  $alfabeto[$i]<a></div>";
									$i=$i+1;
									}
									echo "</div>";
									?>
...
<br />	  			
				...
				if (isset($letter)){
				$query = "select * from item where categoria = \"Poesie\" and (autore like '$letter%' or autore like '<p>$letter%') order by \"autore\"";}
				else {
				$query = "select * from item where categoria = \"Poesie\" order by \"autore\"";
				}
				...
				while ($row = mysql_fetch_row($result))
{
					...
					echo"	<h5><img class=\"calendar\" src=\"images/date.png\" alt=\"Date: \" />Pubblicato il $row[2]<img class=\"bubble\" src=\"images/comments.png\" alt=\"autore: \"/>Autore: Anonimo</h5>";
	  				...
	  				echo "<h2><a href=\"single.php?id=$row[0]\">";echo stripslashes($row[3]); echo"</a></h2>";
